      ...
      <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10">
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
          <div className="col-span-2">
            ...
            <p className="my-4 font-light text-gray-500 dark:text-gray-400">Flowbite is a open-source library of over 400+ web components and interactive elements built with the utility classNamees from Tailwind CSS.</p>
          ...
          <div className="lg:mx-auto">
            ...
            <ul className="text-gray-500 dark:text-gray-400">
              ...
              <li className="mb-4">
                <a href="#" className="hover:underline">Facebook Group</a>
              </li>
              <li className="mb-4">
...
export default OriginalFooterOfFlowbite;